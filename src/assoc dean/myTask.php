<!-- makikita rito ang mga kailangan gawin, halimbawa need na magpasa ng narrative report --> 
<!-- pwede rin dito ipasa ang mga certificate -->
      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">            
            ...
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
              <span class="hide-menu">For Events</span>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="activity.php" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="requirements.php" aria-expanded="false">
                <span>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    ...
                    <a href="myTask.php" class="d-flex align-items-center gap-2 dropdown-item">
